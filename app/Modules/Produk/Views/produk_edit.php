            ...
            <v-form ref="form" v-model="valid">
                ...
                <v-row class="mt-n4">
                    <v-col class="mb-n10" cols="12" md="3">
                        <p class="mb-1 text-subtitle-1 font-weight-bold">Gambar</p>
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" md="9">
                        <v-select v-model="satuanProduk" :items="dataSatuan" item-text="text" item-value="value" :error-messages="satuan_produkError" :loading="loading2" outlined dense></v-select>
                    </v-col>
                </v-row>
                ...
                <v-row class="mt-0">
                    <v-col class="mb-n5" cols="12" md="3">
                        <p class="mb-1 text-subtitle-1 font-weight-bold">Stok</p>
                        <p class="text-caption"></p>
                    </v-col>
                    <v-col cols="12" md="9">
...
<script>
    ...
    methodsVue = {
        ...
        getProduk: function() {
            this.loading2 = true;
            axios.get(`<?= base_url(); ?>/api/produk/${this.idProduk}`, options)
                .then(res => {
                    // handle success
                    this.loading2 = false;
                    var data = res.data;
                    if (data.status == true) {
                        ...
                        this.namaProduk = this.dataProduk.nama_produk;
                        this.barcode = this.dataProduk.barcode;
                        this.idKategori = this.dataProduk.id_kategori;
                        this.merk = this.dataProduk.merk;
                        this.hargaBeli = this.dataProduk.harga_beli;
                        this.hargaJual = this.dataProduk.harga_jual;
                        this.satuanProduk = this.dataProduk.satuan_produk;
                        this.deskripsi = this.dataProduk.deskripsi;
                        this.active = this.dataProduk.active;
                        this.stok = this.dataProduk.stok;
                    } else {
                        this.snackbar = true;
                        this.snackbarMessage = data.message;
                    }
        ...
        getMedia: function() {
            this.loading2 = true;
            axios.get(`<?= base_url(); ?>/api/media/${this.idProduk}`, options)
                .then(res => {
                    // handle success
                    this.loading2 = false;
                    var data = res.data;
        ...
        updateProduct: function() {
            this.loading = true;
            axios.put(`<?= base_url(); ?>/api/produk/update/${this.idProduk}`, {
